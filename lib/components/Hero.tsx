      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-left space-y-8">
          ...
          <p className="max-w-2xl text-lg sm:text-xl text-white slide-up">
            Ofrecemos soluciones innovadoras de ingeniería que transforman ideas
            en realidad, entregando resultados excepcionales para nuestros
            clientes.
          </p>
          <p className="max-w-2xl text-lg sm:text-xl text-white slide-up mt-4">
            Innovadora, joven y comprometida. Somos un equipo que apuesta por el
            futuro con soluciones de vanguardia y un enfoque fresco en todo lo
            que hacemos. Estamos aquí para construir el mañana.
          </p>
