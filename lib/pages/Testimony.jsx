...
const Clients = () => {
  return (
    <section className="container mx-auto w-full md:w-9/12" id="clientes">
      <div className="max-w-4xl mx-auto text-center mb-12">
        <h3 className="text-4xl font-bold mb-6">Nuestra lista de clientes</h3>
        <p className="text-lg text-gray-600">
          ...
          entender y satisfacer las necesidades de cada uno de nuestros
          clientes, asegurándonos de ofrecer soluciones de calidad que generen
          confianza.
        </p>
      </div>

      <div className="px-4">
        <Slider {...sliderSettings} className="testimonials-slider pb-5 m-5">
