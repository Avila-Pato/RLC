            ...
            <div className="space-y-6">
              ...
              <div className="flex  gap-2 md:gap-4  ">
                <div className="shadow-xl flex items-center justify-center rounded-full bg-primary/10 p-2 text-primary  w-1/2">
                  <Shield className="mr-2 h-5 w-5 " color="green" />
            ...
            <Card className="w-full  bg-card/50 backdrop-blur-sm  border-primary/10 transform ">
              <div className="flex flex-col gap-6">
                ...
                <p className="p-6 text-lg md:text-xl leading-relaxed text-gray-900 bg-gradient-to-t from-blue-50 to-white border-b-4 border-blue-500 rounded-xl shadow-lg">
                  Soy un apasionado por la electricidad industrial y la
                  automatización, con más de 8 años de experiencia diseñando e
                  implementando soluciones eléctricas innovadoras. Mi misión es
                  ayudar a las empresas a optimizar su infraestructura eléctrica
                  y alcanzar su máximo potencial en eficiencia y sostenibilidad.
                </p>
              </div>
            </Card>
          </div>
